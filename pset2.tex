...
||\sigma_N f - f||_{\infty},
\eQe
for all $N \in \mathbb{Z}^{+}$. As $f \in C(T)$, we have that 
$||\sigma_N f - f||_{\infty} \to 0$ as $N \to \infty$.
Therefore, by the linearity of limit, 
it suffices to show that $||S_n f - \sigma f||_{\infty} \to 0$ as $n \to \infty$. 
By definition of $S_N$ and $\sigma_N$, 
\eQb
||S_N f - \sigma_N f|| = \sum_{n = -N}^{N}  
\eQe
As $f \in H^{\frac{1}{2}}(\mathbb{T})$, it follows that
Hence, we have that 
